...
def expand_query_with_synonyms(query):
    """Expand the query with synonyms to enhance matching."""
    words = query.split()
...
def find_similar_issues(df, query, top_n=20):
    ...
    query_embedding = model.encode([expanded_query], show_progress_bar=True)[0]
